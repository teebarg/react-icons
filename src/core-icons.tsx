...
export const Link2: React.FC<IconSvgProps> = ({ width = "1em", height = "1em", ...attributes }) => {
    return (
        <svg
            stroke="currentColor"
            fill="none"
...
export const ShieldCheck = ({ height = "1em", width = "1em", ...attributes }: IconSvgProps) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="2"
...
export const WifiOff = ({ height = "1em", width = "1em", ...attributes }: IconSvgProps) => (
    <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="2"
